...
const THEMES = [
  ...
  },
  {
    themeId: 'destination',
    name: '地标旅拍',
    person: '清秀干练的年轻亚洲女性，高马尾，五官立体，笑容明朗',
    shots: [
      { caption: '热带海岛 · 清透分层海', prompt: '白色吊带长裙配宽檐草帽立于海岛浅滩，海水碧蓝分层渐变，棕榈树与白云点缀，大场景构图人物清晰' },
      { caption: '雪山垭口 · 日照金山', prompt: '橙色冲锋衣立于雪山垭口，五彩经幡随风飘动，身后雪峰日照金山，高原辽阔大气' },
      { caption: '沙漠驼影 · 日落沙丘', prompt: '米色长裙披驼色披肩坐在沙丘脊线上，远处驼队剪影，日落侧光刻画沙丘曲线，苍茫辽阔' },
      { caption: '山涧瀑布 · 水雾彩虹', prompt: '红色连衣裙立于山间瀑布观景台，水雾弥漫偶尔折射彩虹，绿植环绕，画面生动通透' },
      { caption: '朱红鸟居 · 日式地道', prompt: '素色和风罩衫走于朱红鸟居长廊，纵深透视构图，晨光柔和，宁静地道氛围' },
      { caption: '洱海公路 · 天空之镜', prompt: '蓝色连衣裙坐于环海公路白椅上，天空之镜倒影，苍山洱海大场景，清新辽阔' }
    ]
  }
];
